        ...
        $("div#pillsList").append(
          `<div class="Pills ${getExpirationClass(doc.expiration)}" id="card_${
            docRef.id
              ...
              <br>
              <button class="icons" onclick="deleteMed('${
                docRef.id
              ...
              <button onclick="window.location.href='edit-medication.html?docId=${
                docRef.id
              }'" class="icons"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
...
function getExpirationClass(medExpiration) {
  ...
  if (daysBeforeExpire < 0) return "med-expired";
  if (daysBeforeExpire < 10) return "med-expiring";
